...
export default function Experience({ darkMode }: ExperienceProps) {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case "Full-time":
        return darkMode ? "bg-white text-black" : "bg-black text-white";
      case "Internship":
        return darkMode ? "bg-gray-200 text-black" : "bg-gray-900 text-white";
      case "Freelance":
        return darkMode ? "bg-gray-300 text-black" : "bg-gray-800 text-white";
      default:
        return darkMode ? "bg-gray-200 text-black" : "bg-gray-900 text-white";
    }
  };
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              <div key={index} className="relative">
                ...
                <div
                  className={`md:ml-16 p-6 rounded-lg shadow-lg transition-transform hover:scale-105 ${
                    darkMode
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    ...
                    <div
                      className={`flex flex-col md:items-end mt-2 md:mt-0 text-sm ${
